...
namespace xihe::sg 
{
    ...
    public:
         ...
         */
        explicit KDTree(std::span<const TElement> elements);
         ...
         */
        void getNeighbors(std::vector<std::size_t>& out, const TElement& from, float maxDistance) const;
         ...
         */
        void rangeSearch(std::vector<std::size_t>& out, const glm::vec3& min, const glm::vec3& max) const;
    ...
    private:
        ...
        void buildInner(Node* pDestination, std::span<const TElement> allElements, const std::vector<std::size_t>& subset, const std::size_t depth, const glm::vec3& regionMin, const glm::vec3& regionMax);
        Node* findClosest(const TElement& element) const;
        void rangeSearchInner(std::vector<std::size_t>& out, const Node* pRoot, const glm::vec3& min, const glm::vec3& max) const;
