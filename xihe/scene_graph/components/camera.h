...
Node &add_line_path_camera(Scene &scene, const std::string &node_name, vk::Extent2D extent, float speed = 1.0f, glm::vec3 start = {0.0f, 0.0f, 0.0f}, glm::vec3 end = {0.0f, 0.0f, 0.0f}, glm::vec3 up_axis = {0.0f, 1.0f, 0.0f});
}
